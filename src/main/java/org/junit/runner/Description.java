...
import kuleuven.groep9.KuLeuven;
...
public class Description implements Serializable {
    ...
    @KuLeuven("This originally private method was made protected to allow extending Description")
    protected Description(Class<?> clazz, String displayName, Serializable uniqueId, Annotation... annotations) {
